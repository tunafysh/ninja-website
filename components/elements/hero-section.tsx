...
export default function HeroSection() {
    ...
    return (
        <div className="relative w-full h-[90%] rounded-3xl overflow-hidden bg-[#D9D9D920]">
          ...
          <motion.div className="absolute aspect-square bg-accent rounded-full right-0 top-0" initial={{width: "0px"}} animate={{ width: "15%"}} transition={{duration: 0.7}} />
          <motion.div className="absolute portrait:hidden w-32 aspect-square rounded-full bg-primary -translate-16 -translate-y-25" animate={{ x: mousePos[0], y: mousePos[1] }} />    
