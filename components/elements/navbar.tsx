  ...
  return(
    <div className=" w-full h-16 flex justify-between items-center">
      ...
      <ul className="px-4 py-2 bg-foreground/15 h-fit flex gap-4 rounded-full">
        <a href="/docs"><li className="hover:bg-foreground/50 p-2 px-4 rounded-full font-bold cursor-pointer">Docs</li></a>
        <a href="/armory"><li className="hover:bg-foreground/50 p-2 px-4 rounded-full font-bold cursor-pointer">Armory</li></a>
        <a href="/"><li className="hover:bg-foreground/50 p-2 px-4 rounded-full font-bold cursor-pointer">Search</li></a>
      </ul>
      <div id="none" />
    </div>
  )
